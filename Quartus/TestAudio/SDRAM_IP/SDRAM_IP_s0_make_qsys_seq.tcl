...
lappend arg_list "--component-param=DELAY_PER_OPA_TAP=753"
...
lappend arg_list "--component-param=MEM_T_RL=3"
...
lappend arg_list "--component-param=MEM_TINIT_CK=82834"
...
lappend arg_list "--component-param=SEQUENCER_VERSION=19.1"
...
lappend arg_list "--component-param=SEQ_ROM=SDRAM_IP_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=SDRAM_IP_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=SDRAM_IP_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=AVL_CLK_PS=12048"
lappend arg_list "--component-param=AFI_CLK_PS=12048"
...
lappend arg_list "--output-name=SDRAM_IP_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=MAX10"
lappend arg_list "--report-file=sopcinfo:SDRAM_IP_s0.sopcinfo"
lappend arg_list "--report-file=txt:SDRAM_IP_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/home/akash/intelFPGA_lite/19.1/quartus//sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
