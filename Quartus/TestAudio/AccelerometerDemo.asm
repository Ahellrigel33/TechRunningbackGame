...
CALL   SetupI2C
Start:
	CALL   ReadX		; Read X value
	STORE  L2A			; Store X value in required mem location
	CALL   ReadY		; Read Y value
	STORE  L2B			; Store Y value in required mem location
	CALL   L2Estimate	; Calculate L2 norm of X and Y value
	SHIFT  -4			; Divide by 16
	OUT    LEDs			; Output final result to LEDs to visualize
