...
; Repeatedly reads and displays the combined X and Y values 
...
Loop:
	...
	CALL	ReadY
	STORE	L2B
	CALL	L2Estimate	; estimates the pythagorean distance of the 
						; X and Y values of the accelerometer.
	SHIFT	-4		; divide the estimate by 16
	OUT		Hex0	; displays estimation on 7-segment display	
	OUT		LEDs	; displays estimation in binary on LEDs
	JUMP	Loop
